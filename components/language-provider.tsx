...
const translations = {
  en: {
    ...
    about: "About Us",
    contact: "Contact",
    "hero.title": "شركة الهوايات للترفية",
    ...
    "promo.title": "Your event is about to become legendary!",
    "promo.price": "499 SAR",
    "promo.starting": "Packages starting from",
    "promo.book": "Book Now",
    "promo.dontmiss": "Don't Miss The Opportunity",
    "features.title": "Why Choose شركة الهوايات للترفية?",
